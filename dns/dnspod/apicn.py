...
class ApiCn:
    def __init__(self, tid, token, **kw):
    ...
    def request(self, **kw):
        ...
        headers = {"Content-type": "application/x-www-form-urlencoded", "Accept": "text/json", "User-Agent": "ZHL DDNS Client/1.0.0(mymymy@email.com)"}
